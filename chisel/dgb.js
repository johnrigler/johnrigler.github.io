...
dgb.opr = function dgbOpr(hex){
    ...
    {
    rest = rest.substr(2)
    release = rest.substr(0,1)
    assetId = rest.substr(1,40)
    assetUniq = rest.substr(41)
    console.log("v30",release,assetId,assetUniq)
    return "v30: " + release + "<hr>" + assetId + "<hr>" + assetUniq
    }
          else
             console.log(version)
          return rest
